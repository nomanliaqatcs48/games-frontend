...
const cards = [
  {
    ...
    cardParagraph:
      "InvoChat is 100% free to start. Pick a team name and a custom URL you can use to access InvoChat easily.",
  },
  {
    id: 2,
    imageName: Two,
    ...
    cardParagraph:
      "InvoChat works best when your entire team is inside. Use InvoChat with an unlimited number of users. ",
  },
  {
    id: 3,
    imageName: Three,
    ...
    cardParagraph:
      "Pick a few major topics that your team talks about frequently, and create your InvoChat rooms to get started.",
  },
  {
    id: 4,
    imageName: Four,
    ...
    cardParagraph:
      "InvoChat is secured with end-to-end encryption. Securely chat and share files for efficient collaboration.",
  },
];
            ...
            {cards.map((val) => (
              <Grid key={val.id} item xs={12} sm={6} md={3}>
                <Box className="card" sx={{ py: 3 }}>
                  ...
                  >
                    <Typography sx={{ textAlign: "center" }} variantMapping="p">
                      {val.cardParagraph}
                    </Typography>
                  </Box>
                </Box>
