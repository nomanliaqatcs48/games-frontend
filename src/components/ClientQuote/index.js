  ...
  return (
    <>
      <div className="clientquote-wrapper">
        <img className="quoteRightImage" src={QuoteRightImage} alt=""/>
        <Container>
          ...
          <Box className="clientquote-content">
            <Box className="quote-mark">
                <img src={QuoteOne} alt=""/>
            </Box>
            <Box className="client-para">
              <Typography variant="h6">
              "InvoChat stands out in terms of user-friendliness and exceptional features."
              </Typography>
            </Box>
            <Box className="client-para">
              <Typography variant="h6">
              "Collaboration and transparency are two important things in the software development sector and InvoChat does not disappoint." 
              </Typography>
            </Box>
            <Box className="client-para">
              <Typography variant="h6">
