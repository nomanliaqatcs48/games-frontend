    ...
    <html {...props.htmlAttributes}>
      <head>
        ...
        <meta
          ...
          content="jMgcmd1e6TmCYq0--r_A5exa8p33tq-keEFHUsthDMk"
        />
        <script
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-5FJVD27')`,
          }}
        />
      ...
      <body {...props.bodyAttributes}>
        <noscript
          dangerouslySetInnerHTML={{
            __html: `<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5FJVD27"
