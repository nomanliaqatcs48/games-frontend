    ...
    <Layout>
      <Container>
        <Box className="pageTerms-wrapper">
          ...
          <Box className="sub-content">
            <Typography variant="h1">License</Typography>
            <Typography variant="h6">
              ...
              <br />
              <br/>
              <Typography className="list-Line">You warrant and represent that:</Typography>
              <br />
              <Box className="listBox">
                <ul>
                  <li>
          ...
          {/* ____________ */}
          <Box className="sub-content">
            <Typography variant="h1">Hyperlinking to our Content</Typography>
            <Typography variant="h6">
              <Typography className="list-Line">
              The following organizations may link to our Website without prior
              written approval:</Typography>
              <br />
              <Box className="listBox">
                <ul>
              ...
              types of organizations:</Typography>
              <br />
              <Box className="listBox">
                <ul>
                  <li>
              ...
              <br/>
              No use of InvoCom's logo or other artwork will be allowed for linking absent a trademark license agreement.
            </Typography>
          </Box>
          <Box className="sub-content">
            <Typography variant="h1">iFrames</Typography>
            <Typography variant="h6">
            Without prior approval and written permission, you may not create frames around our Web Pages that alter in any way the visual presentation or appearance of our Website.
            </Typography>
          </Box>
          <Box className="sub-content">
            <Typography variant="h1">Content Liability</Typography>
            <Typography variant="h6">
            We shall not be held responsible for any content that appears on your Website. You agree to protect and defend us against all claims that are rising on your Website. No link(s) should appear on any Website that may be interpreted as libelous, obscene or criminal, or which infringes, otherwise violates, or advocates the infringement or other violation of, any third party rights.
            </Typography>
          </Box>
          <Box className="sub-content">
            <Typography variant="h1">Your Privacy</Typography>
            <Typography variant="h6">
            Please read Privacy Policy
            </Typography>
          </Box>
          <Box className="sub-content">
            <Typography variant="h1">Reservation of Rights</Typography>
            <Typography variant="h6">
            We reserve the right to request that you remove all links or any particular link to our Website. You approve to immediately remove all links to our Website upon request. We also reserve the right to amend these terms and conditions and its linking policy at any time. By continuously linking to our Website, you agree to be bound to and follow these linking terms and conditions.
            </Typography>
          </Box>
          <Box className="sub-content">
            <Typography variant="h1">Removal of links from our website</Typography>
            <Typography variant="h6">
